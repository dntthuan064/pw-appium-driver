export default async function createSession(this: any, jsonwpDesiredCapabilities: any, reqCaps: any, w3cCapabilities: any) {
  // This will call the parent createSession method which will validate the caps
  const [sessionId, caps] = await this.baseCreateSession(jsonwpDesiredCapabilities, reqCaps, w3cCapabilities);
