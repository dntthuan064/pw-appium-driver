export default async function getAttribute(this: any, elementId: string, attributeName: string) {
  ...
  try {
    ...
    throw new Error(`Failed to get attribute '${attributeName}': ${err.message}`);
  }
} 