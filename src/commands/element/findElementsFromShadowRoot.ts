export default async function findElementsFromShadowRoot(this: any, shadowId: string, strategy: string, selector: string) {
  ...
  try {
    ...
    throw new Error(`Error finding elements in shadow root with strategy ${strategy} and selector ${selector}: ${err.message}`);
  }
